...
WORDLIST_FILENAME = "F:/notes/introduction/week 4/ProblemSet4/words.txt"
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        ...
        if calculateHandlen(hand) == 0:
            print
            print "Run out of letters. Toal score: "+ str(total)+" points" 
            break
